...
#ifndef _PLAYER_AI_POSADJ_INRIGHT_H_
#define _PLAYER_AI_POSADJ_INRIGHT_H_	// 二重インクルード防止
...
// プレイヤー位置補正_右内野コート定義
//==========================================================================
class CPlayerAIPosAdjInRight : public CPlayerPosAdjInRight
{
public:
	...
	// コンストラクタ/デストラクタ
	//=============================
	CPlayerAIPosAdjInRight();
	virtual ~CPlayerAIPosAdjInRight() override;
