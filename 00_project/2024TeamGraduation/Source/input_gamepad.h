...
public:
	...
	// スティック系
	//--------------------------
	CInputGamepad::SAllTrigger GetAllLStickTrigger(STICK_CROSS_AXIS closs);	// Lスティックのトリガー判定
	CInputGamepad::SAllTrigger GetAllRStickTrigger(STICK_CROSS_AXIS closs);	// Rスティックのトリガー判定
