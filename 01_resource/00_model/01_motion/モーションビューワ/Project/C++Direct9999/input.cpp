...
void CInputKeyboard::Update(void)
{
	...
	static int nCntRepeat[NUM_KEY_MAX] = {};
...
CInputGamepad::CInputGamepad()
{
	...
	m_bLeftStickSelect = false;				// 左トリガーの選択判定
...
// 左スティックの判定を取得
//==================================================================================
bool CInputGamepad::GetStickSelect(void)
{
	return m_bLeftStickSelect;
}

//==================================================================================
// 左スティックの判定
//==================================================================================
void CInputGamepad::SetEnableStickSelect(bool bStick)
{
	m_bLeftStickSelect = bStick;
}
